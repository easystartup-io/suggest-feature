...
const Dashboard: React.FC = ({ params }) => {
  ...
  useEffect(() => {
    fetch(`/api/auth/posts/fetch-posts?boardId=${params.id}`, {
      headers: {
  ...
  return (
    <main className="flex flex-1 flex-col gap-4 p-4 lg:gap-6 lg:p-6">
      <div className="flex items-center justify-between">
        <h1 className="text-lg font-semibold md:text-2xl">Post - {data && data.name}</h1>
      </div>
      <div
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      This is the post name. It will be displayed for you to identify here
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      This is the custom domain for the post. You have to setup a CNAME mapping in your DNS server to our domain widget.suggestfeature.com .
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
