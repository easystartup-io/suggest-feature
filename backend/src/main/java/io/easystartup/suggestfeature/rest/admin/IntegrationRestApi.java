 ...
 * @author indianBond
 */
@Path("/unauth/integration")
@Component
public class IntegrationRestApi {

    private static final Logger LOGGER = LoggerFactory.getLogger(IntegrationRestApi.class);
    private final MongoTemplateFactory mongoConnection;
    private final AuthService authService;

    @Autowired
    public IntegrationRestApi(MongoTemplateFactory mongoConnection, AuthService authService) {
