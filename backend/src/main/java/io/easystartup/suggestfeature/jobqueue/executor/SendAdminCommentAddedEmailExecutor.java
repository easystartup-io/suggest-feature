 ...
 * @author indianBond
 */
public class SendAdminCommentAddedEmailExecutor extends  SendStatusUpdateEmailExecutor {

    private static final Logger LOGGER = LoggerFactory.getLogger(SendAdminCommentAddedEmailExecutor.class);
