...
const config = {
  ...
  tagline: 'Easiest Suggest feature tool',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://suggestfeature.com',
  ...
  projectName: 'suggest-feature', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/easystartup-io/suggest-feature/tree/main/docs/',
        },
        // blog: {
